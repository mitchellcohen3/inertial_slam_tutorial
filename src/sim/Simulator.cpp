...
Simulator::Simulator(SimConfig &params_,
...
// // Simulator::Simulator(ov_msckf::VioManagerOptions &imu_traj_params,
...
// bool Simulator::getNextGpsMessage(GpsMessage &gps_data) {
//   // Return if the  IMU should go before us
//   if (timestamp_last_imu + 1.0 / params.sim_freq_imu <
//       timestamp_last_cam + 1.0 / params.sim_freq_meas) {
//     return false;
...
// bool Simulator::getState(double desired_time,
...
//   return true;
// }
// bool Simulator::getImuState(IMUType &imu_state, double stamp) {
