...
public:
  ...
  expMap(const Eigen::Matrix<double, 6, 1> &x);
  ...
  static void toComponents(const Eigen::Matrix<double, 4, 4> &X,
                           Eigen::Matrix3d &C, Eigen::Vector3d &r);
  static Eigen::Matrix<double, 4, 4>
  inverse(const Eigen::Matrix<double, 4, 4> &X);
  static Eigen::Matrix<double, 6, 1>
  minus(const Eigen::Matrix<double, 4, 4> &X1,
