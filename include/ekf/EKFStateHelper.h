...
public:
   ...
   */
  static void EKFPropagation(std::shared_ptr<EKFState> state, const std::vector<std::shared_ptr<ov_type::Type>> &order_NEW,
   ...
   */
  static void EKFUpdate(std::shared_ptr<EKFState> state, const std::vector<std::shared_ptr<ov_type::Type>> &H_order, const Eigen::MatrixXd &H,
   ...
   */
  static void set_initial_covariance(std::shared_ptr<EKFState> state, const Eigen::MatrixXd &covariance,
   ...
   */
  static Eigen::MatrixXd get_marginal_covariance(std::shared_ptr<EKFState> state,
   ...
   */
  static Eigen::MatrixXd get_full_covariance(std::shared_ptr<EKFState> state);
   ...
   */
  static void marginalize(std::shared_ptr<EKFState> state, std::shared_ptr<ov_type::Type> marg);
   ...
   */
  static std::shared_ptr<ov_type::Type> clone(std::shared_ptr<EKFState> state, std::shared_ptr<ov_type::Type> variable_to_clone);
   ...
   */
  static bool initialize(std::shared_ptr<EKFState> state, std::shared_ptr<ov_type::Type> new_variable,
   ...
   * @param res Residual of initializing measurements
   */
  static void initialize_invertible(std::shared_ptr<EKFState> state, std::shared_ptr<ov_type::Type> new_variable,
   ...
   */
  static void augment_clone(std::shared_ptr<EKFState> state, Eigen::Matrix<double, 3, 1> last_w);
   ...
   * @param state Pointer to state
   */
  static void marginalize_old_clone(std::shared_ptr<EKFState> state);

  /**
   * @brief Marginalize bad SLAM features
   * @param state Pointer to state
   */
  static void marginalize_slam(std::shared_ptr<EKFState> state);
